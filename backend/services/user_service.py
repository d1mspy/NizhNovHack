...
оценку давай числом от 1 до 100 включительно, где 1 самый низкий показатель, а 10 самый высокий. в случае если значение определить нельзя, ставь минимальное значение(1), только число, никаких дополнительных пояснений не нужно
